...
public class TokenService implements UniversalTokenService {
    ...
    private final Long YEAR_UNIX = 31536000000L;
    private final Long TEN_MINUTES_UNIX = 600000L;
    ...
    public String generateDeviceToken(String profileID, String deviceID)  {
        ...
        return  Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + TEN_MINUTES_UNIX))
    ...
    public String generateSessionToken(String profileID, String deviceID) {
        return  Jwts.builder()
                ...
                .setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis() + YEAR_UNIX))
                .signWith(SignatureAlgorithm.HS256, KEY)
                .compact();
    }
